...
import static tech.paranoidandroid.cucumber.json.support.Status.FAILED;
import static tech.paranoidandroid.cucumber.json.support.Status.PASSED;
import static tech.paranoidandroid.cucumber.json.support.Status.PENDING;
import static tech.paranoidandroid.cucumber.json.support.Status.SKIPPED;
import static tech.paranoidandroid.cucumber.json.support.Status.UNDEFINED;
...
public class StatusTest {
    ...
    public void valuesOf_ReturnsOrderedStatuses() {
        ...
        // then
        Assertions.assertThat(orderedStatuses).isEqualTo(reference);
    }
