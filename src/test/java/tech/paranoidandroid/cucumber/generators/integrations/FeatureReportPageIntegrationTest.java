...
import tech.paranoidandroid.cucumber.generators.integrations.helpers.EmbeddingAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.FeatureAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.HookAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.HooksAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.OutputAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.StepAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.StepsAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.TableAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.TableRowAssertion;
import tech.paranoidandroid.cucumber.generators.integrations.helpers.TagAssertion;
...
public class FeatureReportPageIntegrationTest extends PageTest {
    ...
    public void generatePage_generatesStatsTableBody() {
        ...
        bodyRow.hasExactValues(feature.getName(), "10", "0", "0", "10", "1", "0", "0", "1", "1:39.263", "Passed");
    }
